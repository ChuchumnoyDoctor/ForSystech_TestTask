...
using TasksManager.src.Localization;

namespace TasksManager.src
{
    ...
    public class ClockControl : ToolStripDropDown
    {
        ...
        public ClockHeaderItem ClockItemColon = new ClockHeaderItem(new CultureInfo("en-US", false).DateTimeFormat.TimeSeparator, false);
        ...
        public ClockHeaderItem ClockItemAMPM = new ClockHeaderItem(new CultureInfo("en-US", false).DateTimeFormat.AMDesignator) { TextAlign = ContentAlignment.MiddleRight };
        ...
        public ClockItem ClockItemAM = new ClockItem(new CultureInfo("en-US", false).DateTimeFormat.AMDesignator);
        ...
        public ClockItem ClockItemPM = new ClockItem(new CultureInfo("en-US", false).DateTimeFormat.PMDesignator);
        ...
        ///<param name="topMost">An option to keep this window topmost.</param>
        ///<param name="showOKCancelbuttonS"></param>
        ///<param name="showAMPMbuttonS"></param>
        ///</summary>
        ...
        public ClockMeridiem ClockMeridiem
        {
            get
            {
                String am = new CultureInfo("en-US", false).DateTimeFormat.AMDesignator;
                return ClockItemAMPM.Text == am ? ClockMeridiem.AM : ClockMeridiem.PM;
            }
            set
            {
                String am = new CultureInfo("en-US", false).DateTimeFormat.AMDesignator;
                String pm = new CultureInfo("en-US", false).DateTimeFormat.PMDesignator;
        ...
        public DateTime Value
        {
            get
            {
                ...
                return new DateTime(value.Year, value.Month, value.Day, hour, minute, value.Second, value.Millisecond, value.Kind);
            }
            set
            {
                if (value == this.value)
                ...
                if (h >= 12)
                {
                    if (h > 12)
                        h -= 12;
                    ampm = new CultureInfo("en-US", false).DateTimeFormat.PMDesignator;
                ...
                else
                {
                    if (h == 0)
                        h = 12;
                    ampm = new CultureInfo("en-US", false).DateTimeFormat.AMDesignator;
        ...
        protected void UpdateClockItemFonts()
        {
            ...
            using (var g = CreateGraphics())
            {
                ...
                MeasureText(ClockItemColon, new CultureInfo("en-US", false).DateTimeFormat.TimeSeparator, g);
                MeasureText(ClockItemMinute, "44", g); // 44 tends to be the widest number
                MeasureText(ClockItemAMPM, new[] { new CultureInfo("en-US", false).DateTimeFormat.AMDesignator, new CultureInfo("en-US", false).DateTimeFormat.PMDesignator }, g);
                //---
                // AM / PM
